...
public class newPdtk3 {
    
    // default values
    public static String gregor_PL = "PB0572199";
    public static String gregor_PL_do ="2022-03-22";
    public static String tadeja_PL = "PB0572172";
    public static String tadeja_PL_do = "2022-03-22";
    public static String zala_PL = "PB0572195";
    public static String zala_PL_do = "2017-03-22";
    public static String mark_PL = "PB0898323";
    public static String mark_PL_do = "2019-04-08";
    public static String spela_PL = "PB0491825";
    public static String spela_PL_do = "2016-04-07";
    
    public static File file = new File("potnilisti.txt");
     ...
     * 
     */
    public static void getExtInfo() throws Exception {
