...
public class PotIzracun {
    ...
    public static void potIzracun() {
    	System.out.println("POT -- BENCIN = " + pot_bencin + " HRK. ["+ hvar.pot.PotCene.bencin_cena +" HRK/L]");
        System.out.println("POT -- AUTOC = " + pot_hac + " HRK.");
    	System.out.println("POT -- OTROCI = " + pot_jdrl_otroci + " HRK.");
    	System.out.println("POT -- ODRASLI = " + pot_jdrl_odrasli + " HRK.");
    	System.out.println("POT -- AVTO = " + pot_jdrl_avto + " HRK.");
        System.out.println("POT -- PRIKOLICA = " + pot_jdrl_prikolica + " HRK.");
    	System.out.println("---------------------------------------------");
    	System.out.println("POT -- SKUPAJ = " + pot_skupaj + " HRK. ["+pot_skupaj_EUR+" EUR; 1 EUR = "+HRK_to_EUR+"]");
        System.out.println("---------------------------------------------");
    }
