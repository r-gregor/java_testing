...
public class StDelovnihUr_V5 {
	...
	public static void main(String[] args) {
		...
		StDelovnihUr_V5 obj = new StDelovnihUr_V5();
		...
		System.out.printf("\nBoth arguments suplied: month (%s) and start day (%d):%n", my_month, 3);
		mesec m4 = new mesec(my_month); m4.setZacetek(3); m4.displayUreNaMesecAll();
		
		System.out.printf("\nBoth arguments suplied: month (%s) and start day (%d):%n", my_month, my_startDay);
		mesec m5 = new mesec(my_month, my_startDay); m5.displayUreNaMesecAll();
		
		System.out.printf("\nOnly month (%s) argument suplied:%n", "Februar");
		mesec m6 = new mesec("Februar"); m6.displayUreNaMesecAll(); m6.displayMesec();
		
		System.out.println("\n" + "NO arguments suplied" + " -- (display All):");
		System.out.println("All months with all working hours per month given the start day displayed ...");
