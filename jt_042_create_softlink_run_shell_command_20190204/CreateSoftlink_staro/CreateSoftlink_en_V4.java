...
// filename: CreateSoftlink_en_V4.java (V4)
...
// $> jar -cvfe CreateSoftlink_d.jar CreateSoftlink_d ./CreateSoftlink_d.class
//
...
public class CreateSoftlink_en_V4 {
     ...
     * @return  the filename without extention for symlink name
     */
    public static void runCommand(String source_f) throws IOException, InterruptedException {
        ...
        */
        ...
        process_1.command("bash", "-c", "ln -snfv " + sf + " " + df);
