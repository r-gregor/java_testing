...
public class DayOfWeek_V2 {
    ...
    DayOfWeek_V2(int currday, int offset) {
    ...
    private void printWeekDay() {
        ...
        int day_init = (this.currday + this.offset) % 7;
        ...
        */
        ...
        day = (day_init < 0)? this.currday - day : day;
        
        // if offset = 0, or offset is divisible by 7, the day is same as currday
        day = (day == 0)? this.currday : day;

        //TEST
        System.out.printf("offset: %d, currday: %d, day_init: %d, end day: %d%n", this.offset, this.currday, day_init, day);
    ...
    public static void main (String[] args) {
        ...
        DayOfWeek_V2 wd = new DayOfWeek_V2(currday, offset);
        wd.printWeekDay();
