...
public class newPdtk4 {
    
    // default values
    private static String gregor_PL = "PB0572199";
    private static String gregor_PL_do ="2022-03-22";
    private static String tadeja_PL = "PB0572172";
    private static String tadeja_PL_do = "2022-03-22";
    private static String zala_PL = "PB0572195";
    private static String zala_PL_do = "2017-03-22";
    private static String mark_PL = "PB0898323";
    private static String mark_PL_do = "2019-04-08";
    private static String spela_PL = "PB0491825";
    private static String spela_PL_do = "2016-04-07";
    
    private static File file = new File("potnilisti.txt");
    
    private static List<Person> lmembers = new ArrayList<Person>();
     ...
     * 
     */
    private static void getExtInfo() throws Exception {
     ...
     */
    private static void print2_ALL() {
        print_inline_header();
     ...
     */
    private static void print_inline_header() {
     ...
     */
    public static Person check_name(String name) {
        for (Person person : lmembers) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Person Gregor = new Person("Gregor", "Redelonghi", "1968-02-22", "2202968500812", "78402069", gregor_PL, gregor_PL_do, "035178605");
        Person Tadeja = new Person("Tadeja", "Mali Redelonghi", "1970-01-19", "1901970505327", "43936954", tadeja_PL, tadeja_PL_do, "035718997");
        Person Zala = new Person("Zala", "Redelonghi", "1996-05-07", "0705996505255", "86319515", zala_PL, zala_PL_do, "043182009");
        Person Mark = new Person("Mark", "Redelonghi", "1999-04-17", "1704999500073", "24626180", mark_PL, mark_PL_do, "044752609");
        Person Spela = new Person("Spela", "Redelonghi", "2008-02-11", "1102008505293", "51275317", spela_PL, spela_PL_do, "048275498");
