...
public class newPdtk6 {
    ...
    private void getExtInfo() throws Exception {
        ...
        // varianta 1
        // File file = new File("./potnilisti.txt");
        // BufferedReader br = new BufferedReader(new FileReader(file));

        // varianta 2
        // BufferedReader br = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("/potnilisti.txt")));
        ...
        */
        ...
        File jarFile = new File(newPdtk6.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
        String inputFilePath = jarFile.getParent() + File.separator + fileName;
