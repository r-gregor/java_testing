...
public class newPdtk7 {
    ...
    private void getExtInfo() throws Exception {
        ...
        File inputFile = new File(newPdtk7.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
        
        String jarFilePath = inputFile.getParent() + File.separator + fileName;
        String classFilePath = inputFile + File.separator + fileName;
        
        String type = newPdtk7.class.getResource("newPdtk7.class").toString();
        String mypath = null;
