...
public class RunPadec6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Vertialna razdalja: = %.3f m%n", pdc1.v_dist);
        System.out.println("-------------------------------------");
