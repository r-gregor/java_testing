...
public class BrthdReminder {
    ...
    private void getInfoFromExtFile() throws Exception {
        ...
        final String classFilePath = inputFile + File.separator + fileName;

        // File myFile = new File("ROJSTNIDNEVI.txt");
        final File myFile = new File(classFilePath);
    ...
    // NOVO NOVO NOVO NOVO NOVO NOVO NOVO NOVO NOVO NOVO NOVO NOVO NOVO NOVO NOVO
