...
public class MoviesDatabase {
	...
	public static String getFilePath(String fileName) throws Exception {
		...
		File inputFile = new File(MoviesDatabase.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			String dbPath = getFilePath(dbFileName);
			String dbFullPathName = dbPath + "/" + dbFileName;
