...
public class Padec5 {
    ...
    Padec5(double start_p, double end_p, double h_dist) {
    ...
    public void calculate_endp() {
        ...
        System.out.printf("Visina koncne tocke za padec vsaj %s mora biti: %.3f m ali vec.%n", mpadec_prcnt, end_p_up);
        System.out.printf("Visina koncne tocke za padec vsaj %s mora biti: %.3f m ali manj.%n", mpadec_prcnt, end_p_down);
